...
Route::get('/principal' , 'DashboardController@getPrincipal');
...
Route::resource('movimentacao/entrada', 'EntradaController');
Route::resource('movimentacao/saida', 'SaidaController');
