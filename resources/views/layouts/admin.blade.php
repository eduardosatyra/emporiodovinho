  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Aqui vai ser o cara logado</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Eduardo Felipe Freitas Satyra
                      <small>Emporio do Vinho System</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="#">À meu tio Kuka Beludo</a>.</strong> Todos os direitos reservados.
      </footer>
